// search.ts — global people search using minisearch.
// Lazy-loads /data/people-index.json on first search keypress.
// people-index.json is generated by the Go backend: one SafePerson per unique person (latest state).
...
/**
 * Search all people across every category.
